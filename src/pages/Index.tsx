...
import { trackContainers } from '@/services/trackingService';
import { Button } from '@/components/ui/button';
import { RefreshCcw, FileSpreadsheet, Sparkles } from 'lucide-react';
        ...
        <section className="max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          <div className="bg-card rounded-2xl border border-border shadow-lg p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Upload Container List</h3>
                <p className="text-sm text-muted-foreground">Excel file with container numbers</p>
              </div>
            </div>
            <FileUpload 
